...
class LoadDatabase {
	...
	@Bean
	CommandLineRunner initDatabase(CakeRepository cakeRepository, List<Cake> initialCakeList) {

		return args -> {
			initialCakeList.stream().peek(c -> log.info("Preloading " + c.toString() + " to Database"))
